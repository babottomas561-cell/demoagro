...
from app.services.lemon_comercial_exportacion_service import get_comercial_exportacion
...
@router.get("/comercial/exportacion")
async def comercial_exportacion(
    ...
    return await cached_panel("comercial", filters, lambda: get_comercial_exportacion(db, filters))
