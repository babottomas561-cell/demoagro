...
from app.services.lemon_macro_mercado_service import get_macro_mercado
...
@router.get("/macro/mercado")
async def macro_mercado(
    ...
    return await cached_panel("macro", filters, lambda: get_macro_mercado(db, filters))
