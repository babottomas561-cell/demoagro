...
from app.services.lemon_riego_service import get_riego_fertirriego
from app.services.panel_realtime import cached_panel

router = APIRouter()


@router.get("/riego/fertirriego")
async def riego_fertirriego(
    ...
    return await cached_panel("riego", filters, lambda: get_riego_fertirriego(db, filters))
