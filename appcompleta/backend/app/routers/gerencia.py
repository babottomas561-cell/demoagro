...
from app.services.lemon_gerencia_service import get_gerencia_general
...
@router.get("/gerencia/general")
async def gerencia_general(
    ...
    return await cached_panel("gerencia", filters, lambda: get_gerencia_general(db, filters))
