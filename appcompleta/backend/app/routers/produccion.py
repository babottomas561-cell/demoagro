...
from app.services.lemon_produccion_service import get_produccion_campo
...
async def produccion_campo(
    ...
    return await cached_panel("produccion", filters, lambda: get_produccion_campo(db, filters))
